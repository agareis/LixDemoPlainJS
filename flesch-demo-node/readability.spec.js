...
describe('lix-calculation', function() {
  ...
  it('should output a Difficulty Level: Very easy', function () {
    expect(computeLix(userTextVeryEasy)).to.equal('Difficulty: Very easy');
  });
  it('should output a Difficulty Level: Easy', function () {
    expect(computeLix(userTextEasy)).to.equal('Difficulty: Easy');
  });
  it('should output a Difficulty Level: Medium', function () {
    expect(computeLix(userTextMedium)).to.equal('Difficulty: Medium');
  });
  it('should output a Difficulty Level: Difficult', function () {
    expect(computeLix(userTextDifficult)).to.equal('Difficulty: Difficult');
  });
  it('should output a Difficulty Level: Very Difficult', function () {
    expect(computeLix(userTextVeryDifficult)).to.equal('Difficulty: Very Difficult');
  });
});
